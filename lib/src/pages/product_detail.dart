  ...
  Widget _productImage() {
    return AnimatedBuilder(
      ...
      child: Stack(
        ...
        children: <Widget>[
          TitleText(text: "DEV", fontSize: 160, color: LightColor.lightGrey),
              ...
              children: <Widget>[
                ...
                Container(
                  child: Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      TitleText(text: AppData.productList[0].name, fontSize: 25),
                      Column(
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              TitleText(
                                text: AppData.productList[0].price.toString(), 
                                fontSize: 25),
                            ],
                          ),
                          Row(
